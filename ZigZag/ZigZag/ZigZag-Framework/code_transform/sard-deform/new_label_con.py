...
def main(pkl, folder_path, save_path):
    f = open(pkl, 'rb')
    ...
    file2 = open(os.path.join(save_path, 'sard_encodeliterals_string.txt'), 'a+')
    # new_label = []
    new_filenames = []
    ...
    for testcase_1 in os.listdir(folder_path):
        for testcase_2 in os.listdir(os.path.join(folder_path, testcase_1)):
            for testcase_3 in os.listdir(os.path.join(folder_path, testcase_1, testcase_2)):
                # testcase_id = testcase_1 + testcase_2 + testcase_3
                        ...
                        if len(sentences) > 2:
                            ...
                            if 1 in strings_indexs:
                                if (strings_indexs.count(1) % 2) == 0:
                                    ...
                                    for new_vulline in new_vullines:
                                        new_filename = os.path.join(folder_path, testcase_1, testcase_2, testcase_3,
    ...
    for new_file in new_filenames:
        ...
        # print new_file_casename
        # new_file_name_label = new_file_casename[-2] + '/' + new_file_casename[-1]
...
if __name__ == '__main__':
    ...
    for each in os.listdir(deform_path):
        result = main(pkl, os.path.join(deform_path, each), save_path)
