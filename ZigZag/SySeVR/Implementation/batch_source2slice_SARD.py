...
start_neo4j_command = "cd /home/SySeVR/neo4j/bin && ./neo4j start && sleep 5s"
stop_neo4j_command = "cd /home/SySeVR/neo4j/bin && ./neo4j stop && sleep 5s"
...
if __name__ == "__main__":
    ...
    for testcase1 in os.listdir(dataset):
        for testcase2 in os.listdir(os.path.join(dataset, testcase1)):
            ...
            run(cd_code_dir_command + "python2 access_db_operate.py " + testcase2,
