...
# problems = set()
# path_error = "/home/SySeVR/Implementation/error.txt"
# # path_error = "/home/SySeVR/Implementation/source2slice/problems.txt"
# with open(path_error, "r") as f:
#     lines = f.readlines()
#     for line in lines:
#         (a, b) = line.strip().strip("\n").split(" ")
#         a = a.split("/")[-1]
#         problems.add((a, b))
#     print problems
...
if __name__ == '__main__':
    ...
    for testID in list_testID:
        ...
        # ID = sys.argv[1].strip()
        # print ">>> " + testID
        # if (ID, testID) in problems:
        #     print "Pass: " + ID + " "+ testID
        #     continue
