...
def api_slice():
    count = 1
    store_filepath = "slices/api_slices.txt"
...
def pointers_slice():
    count = 1
    store_filepath = "slices/pointer_slices.txt"
...
def arrays_slice():
    count = 1
    store_filepath = "slices/array_slices.txt"
...
def integeroverflow_slice():
    count = 1
    store_filepath = "slices/expr_slices.txt"
